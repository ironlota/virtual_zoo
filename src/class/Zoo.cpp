...
void Zoo::TotalFood(){
	...
	cout << animal_[i]->GetName() << " is " << animal_[i]->GetFoodType() << " and eat " << animal_[i]->Eat() << " kg" << endl;
	cout << "Total meat for Carnivores and Omnivores = " << meat << " kg" << endl;
	cout << "Total grass for Herbivores and Omnivores = " << grass << " kg" << endl;
	clearwait(1);
	}
}
