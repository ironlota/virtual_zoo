...
SOURCES=$(wildcard ./src/*.cpp) $(wildcard ./src/*/*.cpp) $(wildcard ./src/Class/*/*.cpp) $(wildcard ./src/Class/Animal/*/*.cpp) $(wildcard ./src/Class/Cell/*/*.cpp) $(wildcard ./src/Class/Cell/Habitat/*/*.cpp) 
